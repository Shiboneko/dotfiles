...
link $FILEDIR/vim/vimtips $VIMDIR/vimtips

e_git git://github.com/scrooloose/syntastic.git $VIMDIR/bundle/syntastic
e_git https://github.com/godlygeek/tabular.git $VIMDIR/bundle/tabular
